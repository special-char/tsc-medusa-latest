...
export class Customer {
  ...
  async listAddresses(id: string, headers?: ClientHeaders) {
    return this.client.fetch<HttpTypes.AdminCustomerAddressListResponse>(
  ...
  async listCustomerAddress(
    id: string,
    address_id: string,
    headers?: ClientHeaders
  ) {
    return this.client.fetch<HttpTypes.AdminCustomerAddressResponse>(
  ...
  async updateAddress(
    ...
    return this.client.fetch<HttpTypes.AdminUpdateCustomerAddress>(
      `/admin/customers/${id}/addresses/${address_id}`,
      {
        method: "POST",
        body,
  ...
  async deleteAddress(id: string, address_id: string, headers?: ClientHeaders) {
    return this.client.fetch<HttpTypes.AdminCustomerAddressDeleteResponse>(
      `/admin/customers/${id}/addresses/${address_id}`,
      {
        method: "DELETE",
        headers,
