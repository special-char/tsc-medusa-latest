...
export class Banner {
  ...
  async delete(id: string) {
    return await this.client.fetch(`/admin/banner-images/${id}`, {
      method: "DELETE",
    })
  }
  ...
  async create(body: BannerType) {
    ...
    return await this.client.fetch(`/admin/banner-images`, {
      method: "POST",
      headers: {
        "content-type": null,
      },
  ...
  async retrieve(id: string) {
    return await this.client.fetch<BannerProps>(`/admin/banner-images/${id}`, {
      method: "GET",
    })
  }
}
