  ...
  (
    ...
    return (
      <div className={clsx("flex w-full flex-col gap-2", className)} {...props}>
        ...
        <div
          className={clsx(
            "bg-grey-5 border-gray-20 px-small py-xsmall rounded-rounded focus-within:shadow-input focus-within:border-violet-60 flex w-full items-center rounded-lg border",
            {
        ...
        >
          ...
          <input
            className={clsx(
              "remove-number-spinner leading-base text-grey-90 caret-violet-60 placeholder-grey-40 w-full bg-transparent p-2 font-normal outline-none outline-0",
