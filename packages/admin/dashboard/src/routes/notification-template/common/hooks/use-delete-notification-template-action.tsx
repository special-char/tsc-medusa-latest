...
export const useDeleteNotificationTemplateAction = (
  id: string,
  setNotificationTemplates?: (notificationTemplates: any[]) => void | null,
  setNotificationTemplate?: (notificationTemplate: any) => void | null
) => {
  ...
  const handleDelete = async () => {
    const result = await prompt({
      ...
      description: `You are about to delete the notification template. This action cannot be undone.`,
